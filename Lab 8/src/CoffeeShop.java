...
/******** 
 * BINDING: Bound submit button to Name-entry field to assert name field is filled out
 * EVENTS: Found in CoffeeListeners.java. Has separate listeners for each option in the CoffeeShop (mainly action-event listeners). MouseEvent listener is on summary screen.
 ********/
